...
AFRAME.registerComponent("markerhandler", {
  ...
  askTableNumber: function() {
    ...
    swal({
      title:"Welcome to Freddy Fazbear's Pizzeria!",
      icon:iconUrl,
      content:{
        element:"input",
        attributes:{
  ...
  handleOrder: function(tNumber, dish) {
    ...
    .then(doc=>{
      ...
      if (details["current_orders"][dish.id]){
        ...
        var current_quant = details["current_orders"][dish.id]["quantity"]
        details["current_orders"][dish.id]["subtotal"]=current_quant*dish.price
      }
      else{
